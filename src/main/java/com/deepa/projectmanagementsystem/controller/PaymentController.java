...
import com.deepa.projectmanagementsystem.response.PaymentLinkResponse;
...
public class PaymentController {
 ...
 public ResponseEntity<PaymentLinkResponse> createPaypalLink(
 ...
 @RequestHeader("Authorization") String jwt )throws Exception{
  ...
  if(planType.equals(PlanType.ANNUALLY)){
    ...
    paymentLinkRequest.put("callback url", "http://localhost:4474/upgrade_plan/success?planType"+planType);
